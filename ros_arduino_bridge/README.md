...
This version works with an ESP-01 connected to an Arduino MEGA board. AT commands are used to send and recieve the messages.
Modifications by: Alberto Díaz Rodríguez
